  ...
  constructor() {
    ...
    this.translations = {
      en: {
        ...
        lbl_login_callsign: 'Email Address',
        lbl_login_key: 'Password',
        btn_login_submit: 'Sign In & Launch Console',
        lbl_signup_name: 'Full Name',
        lbl_signup_email: 'Email Address',
        lbl_signup_pw: 'Password',
      ...
      kn: {
        ...
        lbl_login_callsign: 'ಇಮೇಲ್ ವಿಳಾಸ',
        lbl_login_key: 'ಪಾಸ್‌ವರ್ಡ್',
        btn_login_submit: 'ಸೈನ್ ಇನ್ ಮಾಡಿ ಮತ್ತು ಕನ್ಸೋಲ್ ಪ್ರಾರಂಭಿಸಿ',
        lbl_signup_name: 'ಪೂರ್ಣ ಹೆಸರು',
        lbl_signup_email: 'ಇಮೇಲ್ ವಿಳಾಸ',
        lbl_signup_pw: 'ಪಾಸ್‌ವರ್ಡ್',
      ...
      hi: {
        ...
        lbl_login_callsign: 'ईमेल पता',
        lbl_login_key: 'पासवर्ड',
        btn_login_submit: 'साइन इन करें एवं कंसोल शुरू करें',
        lbl_signup_name: 'पूरा नाम',
        lbl_signup_email: 'ईमेल पता',
        lbl_signup_pw: 'पासवर्ड',
      ...
      ta: {
        ...
        lbl_login_callsign: 'மின்னஞ்சல் முகவரி',
        lbl_login_key: 'கடவுச்சொல்',
        btn_login_submit: 'உள்நுழைந்து கன்சோலைத் தொடங்கவும்',
        lbl_signup_name: 'முழு பெயர்',
        lbl_signup_email: 'மின்னஞ்சல் முகவரி',
        lbl_signup_pw: 'கடவுச்சொல்',
